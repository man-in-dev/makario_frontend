...
const ProductDetail: React.FC = () => {
    ...
    // Generate product schema with offers, aggregateRating, and reviews
    const productSchema = {
        "@context": "https://schema.org",
        "@type": "Product",
        "@id": `https://makario.in/product/${displayProduct.id}`,
        "name": displayProduct.name,
        ...
        "offers": {
            ...
            "url": `https://makario.in/product/${displayProduct.id}`,
            "priceCurrency": "INR",
        ...
        "aggregateRating": {
            ...
            "ratingValue": displayProduct.rating.toString(),
            "ratingCount": displayProduct.reviewCount.toString(),
            "bestRating": "5",
            "worstRating": "1"
        },
        "review": [
            {
                ...
                "reviewBody": "Amazing quality makhana with perfect peri-peri seasoning. Fresh, crunchy and perfectly roasted. The spice level is just right - not too hot but definitely flavorful. Definitely recommending to others!",
            ...
            },
            {
                ...
                "reviewBody": "Love the spicy peri-peri flavor and it's a healthy snacking option. Perfect for evening cravings when you want something tasty yet nutritious. Fast delivery and good packaging. Will order again!",
                "name": "Great Taste & Healthy"
            }
        ]
    };
                        ...
                        <div className="space-y-4 pt-2">
                            ...
                            <div className="flex gap-4">
                                <Button
                                    ...
                                    disabled={!displayProduct.inStock || isProcessing}
                                >
