        ...
        <div className="relative ml-2">
          ...
          {profileMenuOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden z-50">
              <div className="p-4 border-b border-gray-200 bg-gray-50">
                <p className="font-semibold text-gray-800">Raja Raj</p>
              ...
              <div className="p-2 border-t border-gray-200 bg-gray-50">
                <button className="w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-red-50 flex items-center gap-2 transition-colors rounded">
                  <LogOut size={16} />
                  Logout
                </button>
              </div>
