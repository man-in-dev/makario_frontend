...
export default function PageEdit() {
  ...
  const handleSave = () => {
    ...
    console.log('Updated Page Data:', formData);
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 py-6 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">✏️ Edit Page</h1>
              <p className="text-sm text-gray-500 mt-1">Update your page content and settings</p>
            </div>
          </div>
        </div>
      </div>
