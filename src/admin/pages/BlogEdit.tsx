...
export default function BlogEdit() {
  ...
  const [formData, setFormData] = useState<BlogFormData>({
    ...
    featured: true,
    visibility: 'public',
    seoTitle: 'Sample Blog Post Title',
    seoDescription: 'Sample meta description',
    metaKeywords: 'blog, sample',
  });
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 py-6 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">✏️ Edit Blog Post</h1>
              <p className="text-sm text-gray-500 mt-1">Update your content and settings</p>
            </div>
          </div>
        </div>
      </div>
